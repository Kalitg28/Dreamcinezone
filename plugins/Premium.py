    ...
    if len(message.command) == 2:
        ...
        if await db.remove_premium_access(user_id):
            ...
            await client.send_message(
                chat_id=user_id,
                text=f"<b>ʜᴇʏ {user.mention},\n\n𝒀𝒐𝒖𝒓 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑨𝒄𝒄𝒆𝒔𝒔 𝑯𝒂𝒔 𝑩𝒆𝒆𝒏 𝑹𝒆𝒎𝒐𝒗𝒆𝒅. 𝑻𝒉𝒂𝒏𝒌 𝒀𝒐𝒖 𝑭𝒐𝒓 𝑼𝒔𝒊𝒏𝒈 𝑶𝒖𝒓 𝑺𝒆𝒓𝒗𝒊𝒄𝒆 😊. 𝑪𝒍𝒊𝒄𝒌 𝑶𝒏 /plan 𝑻𝒐 𝑪𝒉𝒆𝒄𝒌 𝑶𝒖𝒓 𝑶𝒕𝒉𝒆𝒓 𝑷𝒍𝒂𝒏𝒔.\n\n<blockquote>உங்கள் பிரீமியம் அணுகல் அகற்றப்பட்டது. எங்கள் சேவையைப் பயன்படுத்தியதற்கு நன்றி 🥳 எங்கள் மற்ற திட்டங்களைப் பார்க்க /plan என்பதைக் கிளிக் செய்யவும். ।</blockquote></b>"
            )
        else:
...
async def myplan(client, message):
    ...
    if data and data.get("expiry_time"):
        ...
        await message.reply_text(f"<b>ʜᴇʏ {user},\n\n𝒀𝒐𝒖 𝑫𝒐 𝑵𝒐𝒕 𝑯𝒂𝒗𝒆 𝑨𝒏𝒚 𝑨𝒄𝒕𝒊𝒗𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝒑𝒍𝒂𝒏𝒔, 𝑰𝒇 𝒀𝒐𝒖 𝑾𝒂𝒏𝒕 𝑻𝒐 𝑻𝒂𝒌𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑻𝒉𝒆𝒏 𝑪𝒍𝒊𝒄𝒌 𝑶𝒏 𝑩𝒆𝒍𝒐𝒘 𝑩𝒖𝒕𝒕𝒐𝒏 👇\n\n<blockquote>உங்களிடம் எந்த செயலில் உள்ள 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑷𝒍𝒂𝒏𝒔 இல்லை, நீங்கள் 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 பெற விரும்பினால், கீழே உள்ள 𝑩𝒖𝒕𝒕𝒐𝒏 ஐக் கிளிக் செய்யவும் 👇</blockquote><b>",
